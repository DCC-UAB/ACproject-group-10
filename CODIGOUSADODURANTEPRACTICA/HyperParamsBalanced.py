...
output_file = open('Hyperparams2Balanced.txt', 'w')
...
df_positive = dfSimpleBinary[dfSimpleBinary['Score'] == 1]
df_negative = dfSimpleBinary[dfSimpleBinary['Score'] == 0]
...
plt.savefig('hyperParams2Balanced_plots/roc_before.png')
plt.close()
...
plt.legend(loc="lower right")
plt.savefig('hyperParams2Balanced_plots/roc_after.png')
plt.close()
...
plt.legend(loc="lower right")
plt.savefig('hyperParams2Balanced_plots/roc_comparative.png')
plt.close()
...
for model_name, model in models.items():
    ...
    plt.ylabel('Real')
    plt.savefig(f'hyperParams2Balanced_plots/confusion_matrix_{model_name}.png')
    plt.close()
    ...
    if len(coefs) == len(feature_names):
        ...
        plt.xlabel('Peso')
        plt.ylabel('Palabras')
        plt.savefig(f'hyperParams2Balanced_plots/top_words_{model_name}.png')
        plt.close()
    else:
